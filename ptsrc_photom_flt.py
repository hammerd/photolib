...
if __name__=='__main__':
	...
	ascii.write(tt, filter+'_photcat.dat', names=['#filename','amp','shutter','mjd_avg','mjd_deltat','chip',\
	 'axis1','axis2','xc','yc','xcp','ycp','background','background_rms','exptime', 'biaslevel', 'dqflag', \
         'f1','f2','f3','f4','f5','f6','f7','f8','f9','f10','f12','f14','f16', 'f18','f20','f24','f28','f32','f36', \
         'f40','f45','f50','f55','f60','f65','f70','m1','m2','m3','m4','m5','m6','m7','m8','m9','m10','m12','m14','m16',\
         'm18','m20','m24','m28','m32','m36','m40','m45','m50','m55','m60','m65','m70'], \
         formats={'#filename':'%s','amp':'%s','shutter':'%s','mjd_avg':'%9.4f', 'mjd_deltat':'%6.4f', \
         'chip':'%i', 'axis1':'%i', 'axis2':'%i','xc':'%8.3f', 'yc':'%8.3f', 'xcp':'%8.3f', 'ycp':'%8.3f', \
         'background':'%0.5f','background_rms':'%0.5f', 'exptime':'%0.2f', 'biaslevel': '%0.4f', 'dqflag': '%i', \
	 'f1':'%0.2f', 'f2':'%0.2f','f3':'%0.2f','f4':'%0.2f','f5':'%0.2f','f6':'%0.2f','f7':'%0.2f','f8':'%0.2f', \
	 'f9':'%0.2f','f10':'%0.2f','f12':'%0.2f','f14':'%0.2f','f16':'%0.2f','f18':'%0.2f', 'f20':'%0.2f', \
	 'f24':'%0.2f','f28':'%0.2f','f32':'%0.2f','f36':'%0.2f','f40':'%0.2f','f45':'%0.2f','f50':'%0.2f', \
	 'f55':'%0.2f','f60':'%0.2f','f65':'%0.2f','f70':'%0.2f','m1':'%0.2f', 'm2':'%0.2f','m3':'%0.2f', \
	 'm4':'%0.2f','m5':'%0.2f','m6':'%0.2f','m7':'%0.2f','m8':'%0.2f','m9':'%0.2f','m10':'%0.2f','m12':'%0.2f', \
	 'm14':'%0.2f','m16':'%0.2f','m18':'%0.2f','m20':'%0.2f','m24':'%0.2f','m28':'%0.2f','m32':'%0.2f', \
	 'm36':'%0.2f','m40':'%0.2f','m45':'%0.2f','m50':'%0.2f','m55':'%0.2f','m60':'%0.2f','m65':'%0.2f','m70':'%0.2f'})
